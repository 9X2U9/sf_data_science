...
На вход подается целое число от 0 до 100.

:arrow up:[к оглавлению](https://github.com/9X2U9/sf_data_science/tree/main/SF_DATA_SCIENCE/project_0.README.md#Оглавление)

### Этапы работы над проектом

- Проработка математического решения
- Написание алгоритма
- Описание проекта
...
Если информация по этому проекту покажется Вам интересной или полезной, то я буду очень благодарна Вам, если отметите репозиторий и профиль ⭐️⭐️⭐️-дами.